...
<details>
<summary><b>為什麼要兩份 build?(面試會問)</b></summary>
...
其餘 8 項是把環境寫下來存證。三個月後你會忘記當時的版本長怎樣,**而面試官會問。**
...
**規則:每一個被寫進表格或履歷的數字,都要指得到一個 `manifest.json`。**
...
**這一塊比整個 repo 都重要,而且很多人搞反。**

這個 repo 證明的是「你建過一套系統、量過它、想過它」。
它**不證明**「你能在白板上、憑記憶、二十分鐘內寫出正確的 C」。
**那是另一種能力,會安靜地退化,而且通常先考。**
...
### `LOG.md` 才是這個 repo 最值錢的檔案

不是 README。README 誰都寫得出來。

每一則要有五段:**現象 / 假設 / 先驗哪個、為什麼 / 根因 / 教訓**。

> ★ 「先驗哪個、為什麼」這一行,是「你怎麼 debug?」那一題的全部價值。
> 說得出「我先驗 A 因為它最便宜而且能一次砍掉一半可能性」的人,
> 跟說「我就一個一個試」的人,是兩種工程師。
